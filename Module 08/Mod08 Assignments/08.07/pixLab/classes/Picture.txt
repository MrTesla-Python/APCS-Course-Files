...
public class Picture extends SimplePicture 
{
  ...
  public void grayscale()
  {
    ...
    for (Pixel[] rowArray : pixels)
    {
      for (Pixel pixelObj : rowArray)
      {
        int total = pixelObj.getBlue() + pixelObj.getRed() + pixelObj.getGreen();
        total /= 3;
  ...
  public void fixUnderWater()
  {
    ...
    for (Pixel[] rowArray : pixels)
    {
      for (Pixel pixelObj : rowArray)
      {
        ...
        pixelObj.setRed(pixelObj.getRed() + brightness);
        pixelObj.setGreen(pixelObj.getGreen() - contrast);
        pixelObj.setBlue(pixelObj.getBlue() - contrast);
      }
    }
  }
