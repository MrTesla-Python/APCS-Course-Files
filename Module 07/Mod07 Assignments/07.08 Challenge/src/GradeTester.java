...
public class GradeTester {
    ...
    public static void main(String[] args)
    {
        ...
        classroom.add(new Student ("Gavin Velez", 55, 65, 75, 90, 80));
        classroom.add(new Student ("Logan Van", 75, 73, 85, 90, 100));
        classroom.add(new Student ("John Dauns", 20, 10, 15, 13, 15));
        classroom.add(new Student ("Bob Lee", 80, 83, 82, 86, 80));
        classroom.add(new Student ("Joe Doe", 100, 100, 95, 90, 96));
    ...
    public static void traverse(List<Student> classroom)
    {
    ...
    public static void replaceStudent(List<Student> classroom, String find, String replace)
    {
    ...
    public static void replaceGrade(List<Student> classroom, String student, int find, int replace)
    {
        for (int index = 0; index < classroom.size(); index++)
        {
    ...
    public static void replaceFullStudent(List<Student> classroom, String student, String replace, int Q1, int Q2, int Q3, int Q4, int Q5)
    {
        for (int index = 0; index < classroom.size(); index++)
        {
            if (classroom.get(index).getName().equals(student)) classroom.set(index, new Student(replace, Q1, Q2, Q3, Q4, Q5));
        }
    }

    public static void insertStudent(List<Student> classroom, String student, String replace, int Q1, int Q2, int Q3, int Q4, int Q5)
    {
        for (int index = 0; index < classroom.size(); index++)
        {
            Student currentStudent = classroom.get(index);
            if (currentStudent.getName().equals(student)) 
            {
                classroom.add(index, new Student(replace, Q1, Q2, Q3, Q4, Q5));
                break;
            }
        }
    }

    public static void deleteStudent(List<Student> classroom, String find)
    {
        for (int index = 0; index < classroom.size(); index++)
        {
